...
```javascript
import atan2f from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-atan2f@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-atan2f/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/math-base-special-atan2f/actions/workflows/test.yml?query=branch:v0.1.1
